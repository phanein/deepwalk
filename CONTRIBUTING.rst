...
Report bugs at https://github.com/phanein/deepwalk/issues.
...
The best way to send feedback is to file an issue at https://github.com/phanein/deepwalk/issues.
...
1. Fork the `deepwalk` repo on GitHub.
2. Clone your fork locally::

    $ git clone git@github.com:your_name_here/deepwalk.git
...
To run a subset of tests::
	...
	$ python -m unittest tests.test_deepwalk